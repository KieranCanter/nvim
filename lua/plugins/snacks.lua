...
return {
  ...
  keys = {
    ...
    -- LSP
    { "gld", function() Snacks.picker.lsp_definitions() end, desc = "Goto LSP [d]efinition" },
    { "glD", function() Snacks.picker.lsp_declarations() end, desc = "Goto LSP [D]eclaration" },
    { "glr", function() Snacks.picker.lsp_references() end, nowait = true, desc = "Goto LSP [r]eferences" },
    { "gli", function() Snacks.picker.lsp_implementations() end, desc = "Goto LSP [i]mplementation" },
    { "glt", function() Snacks.picker.lsp_type_definitions() end, desc = "Goto LSP [t]ype Definition" },
    { "gls", function() Snacks.picker.lsp_symbols() end, desc = "LSP [s]ymbols" },
    { "glS", function() Snacks.picker.lsp_workspace_symbols() end, desc = "LSP Workspace [S]ymbols" },
    -- Helpful for dev
